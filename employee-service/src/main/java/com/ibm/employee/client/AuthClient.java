...
public class AuthClient {
    ...
    public Optional<Map<String, String>> createUserFromEmployee(String username, String email, String authorizationHeader) {
        try {
            ...
            syncRequest.put("username", username);
            ...
            if (response.getStatusCode().is2xxSuccessful() && response.getBody() != null) {
                ...
                if (body.get("data") instanceof Map) {
                    ...
                    result.put("employeeId", (String) data.get("employeeId"));
